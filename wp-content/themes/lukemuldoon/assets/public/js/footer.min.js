...
var SVG_PATH = 'M3,9 C50,11 90,4 150,7 C200,10 250,4 297,7';
var SVG_COLOR = '#9FE000';
...
function buildCountupTween(data, duration) {
  ...
  return gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(data.proxy, {
    val: data.number,
    duration: duration,
    ease: 'power3.out',
    onUpdate: function onUpdate() {
      var v = Number.isInteger(data.number) ? Math.round(data.proxy.val) : data.proxy.val.toFixed(1);
...
document.querySelectorAll('.js-reveal').forEach(function (container) {
  ...
  var underlinePaths = Array.from(container.querySelectorAll('.accent-underline')).map(injectUnderlineSVG).filter(Boolean);
  var statCountups = Array.from(container.querySelectorAll('.stat-item__main')).map(setupCountup).filter(Boolean);
...
(function () {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.set(ringCircle, {
...
/***/ "./assets/src/js/scripts/contact-form.js":
/*!***********************************************!*\
  !*** ./assets/src/js/scripts/contact-form.js ***!
  \***********************************************/
/***/ (function() {
...
/***/ "./assets/src/js/scripts/header-height.js":
/*!************************************************!*\
  !*** ./assets/src/js/scripts/header-height.js ***!
  \************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
(function () {
  ...
  function openMenu() {
    ...
    (0,_body_scroll_lock_facade__WEBPACK_IMPORTED_MODULE_0__.disableBodyScroll)(nav);
  ...
  function closeMenu() {
    ...
    (0,_body_scroll_lock_facade__WEBPACK_IMPORTED_MODULE_0__.enableBodyScroll)(nav);
    toggle.focus();
  }
...
/***/ "./assets/src/js/scripts/scanner.js":
/*!******************************************!*\
  !*** ./assets/src/js/scripts/scanner.js ***!
  \******************************************/
/***/ (function() {
...
(function () {
  ...
  var form = document.querySelector('.scanner');
  var modal = document.getElementById('scanner-modal');
  if (!form || !modal) return;
  var backdrop = modal.querySelector('.scanner-modal__backdrop');
  var loading = modal.querySelector('.scanner-modal__loading');
  var results = modal.querySelector('.scanner-modal__results');
  var urlSpan = modal.querySelector('.scanner-modal__url');
  var siteName = modal.querySelector('.scanner-modal__site-name');
  var closeBtn = modal.querySelector('.scanner-modal__close');
  var ctaNote = modal.querySelector('.scanner-modal__cta-note');
  var ctaLink = modal.querySelector('.scanner-modal__cta');
  var scoreEls = modal.querySelectorAll('[data-category]');
  ...
  function ctaContent(scores) {
    ...
    var avg = Math.round(vals.reduce(function (a, b) {
      return a + b;
    }, 0) / vals.length);
    var allGood = vals.every(function (s) {
      return s >= 90;
    });
    if (allGood) {
      return {
...
/* harmony import */ var _scripts_mobile_nav__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scripts/mobile-nav */ "./assets/src/js/scripts/mobile-nav.js");
/* harmony import */ var _scripts_scanner__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scripts/scanner */ "./assets/src/js/scripts/scanner.js");
/* harmony import */ var _scripts_scanner__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_scripts_scanner__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _scripts_header_height__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./scripts/header-height */ "./assets/src/js/scripts/header-height.js");
/* harmony import */ var _scripts_contact_form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./scripts/contact-form */ "./assets/src/js/scripts/contact-form.js");
/* harmony import */ var _scripts_contact_form__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_scripts_contact_form__WEBPACK_IMPORTED_MODULE_5__);
...
(function ($) {
  $('a[href*="#"]').not('[href="#"]').not('[href="#0"]').not('[role="tab"]').not('.glightbox-inline').on('click', function (event) {
    if (location.pathname.replace(/^\//, '') === this.pathname.replace(/^\//, '') && location.hostname === this.hostname) {
      ...
      var headerHeight = $header.length ? Math.ceil($header.outerHeight(true)) : 0;
      $('html, body').animate({
